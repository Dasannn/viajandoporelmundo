...
PokéGlobe — An interactive 3D Earth globe with Pokemon-style UI. Built with Three.js + TanStack Start, deployed on Netlify. Single-page application; no backend or database required.
